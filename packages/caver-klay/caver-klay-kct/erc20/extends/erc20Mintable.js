...
class ERC20Mintable extends ERC20 {
    static deploy(tokenInfo, deployer) {
        const erc20Mintable = new ERC20Mintable()
        return erc20Mintable.deploy(tokenInfo, deployer)
    }

    constructor(tokenAddress) {
        super(ERC20_TYPES.ERC20Mintable, tokenAddress)
    }
